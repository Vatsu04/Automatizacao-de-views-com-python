...
def run_simple():
    ...
    class ViewBot:
        ...
        def __init__(self, mastersimple):
            ...
            #self.disclaimer_label = Label(mastersimple, text="Video length:")
            #self.disclaimer_label.grid(row=2, column=0, padx=10, pady=10)
            ...
            self.quit_button = Button(mastersimple, text="Quit",  command= mastersimple.quit)
            ...
            self.advanced_run.grid(row=6, column=3, padx=10, pady=10  )
